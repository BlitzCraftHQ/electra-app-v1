...
const GOVERNOR = require("./electra-contracts/deployments/althea/GovernorContract.json");
const STATION_REGISTRY = require("./electra-contracts/deployments/althea/StationRegistry.json");
const VEHICLE_LEDGER = require("./electra-contracts/deployments/althea/VehicleLedger.json");
const ELECTRA_TOKEN = require("./electra-contracts/deployments/althea/ElectraToken.json");

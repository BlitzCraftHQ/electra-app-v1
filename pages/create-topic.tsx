...
export default function CreateTopic() {
  ...
  return (
    <>
      <Head>
        <title>
          Create Topic - Electra | Push Notification Service for the Neo
          Blockchain
        </title>
        <meta
          name="title"
          content="Create Topic - Electra | Push Notification Service for the Neo Blockchain"
        />
        <meta
          name="description"
      ...
      <ApplicationLayout>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-1 text-sm leading-6 text-zinc-600">
            Electra makes it extremely easy to open and maintain a genuine Topic

...
export default function Hero() {
  return (
    <>
      {/* <div
        id="hero"
        className="isolate bg-gradient-to-r from-cyan-950 to-sky-950 overflow-hidden"
      >
        <svg
          ...
          <div className="mx-auto max-w-7xl px-6 py-16 md:py-16 lg:px-8 lg:pt-12 lg:pb-24 xl:pt-0">
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                <h1 className="text-4xl sm:text-5xl lg:text-5xl font-black tracking-tight text-white">
                  {/* The First Comms Protocol for the <br /> Neo Blockchain! 
                  <span className="text-sky-500">Lease</span> your EV chargers.
                  <br />
                  <span className="text-sky-500">Recharge</span> your EV cars.
                  <br />
                  <span className="text-sky-500">Earn</span> ElectraCoins.
                </h1>
                ...
                <div className="mt-16 flex items-center gap-x-6">
                  <Link
                    href="#sign-up"
                    scroll={false}
                    className="rounded-md bg-sky-600 shadow-[0px_0px_40px_30px_#88888824] px-12 py-4 text-xl font-semibold text-white hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600 transition-all ease-in-out duration-200"
                  >
                    Launch dApp
                  </Link>
                </div>
      ...
      <div className="relative isolate overflow-hidden bg-cyan-900 pb-16 pt-0 sm:pb-20">
        <Image
          src="/hero-darkened.webp"
          alt="EV Car"
          height={1037}
          width={1920}
          className="absolute inset-0 -z-10 h-full w-full object-cover backdrop-opacity-20 backdrop-invert bg-black/50"
        />
        <div
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-cyan-950 to-sky-950 opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
          ...
          <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:pt-48 lg:pb-56">
            ...
            <div className="text-center">
              <div className="text-4xl font-black tracking-tight text-white sm:text-6xl space-y-3">
                <div>
                  <span className="text-cyan-500">Lease</span> your EV chargers.
                </div>
                <div>
                  <span className="text-cyan-500">Recharge</span> your EV
                  vehicles.
                </div>
                <div>
                  <span className="text-cyan-500">Earn</span> ElectraCoins.
                </div>
              </div>
        ...
        >
          <div
            className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-cyan-950 to-sky-950 opacity-20 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
            }}
